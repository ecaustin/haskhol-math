...
defZIP' :: (BasicConvs thry, IndTypesCtxt thry) => HOL Theory thry HOLThm
defZIP' = newRecursiveDefinition "ZIP" recursionLIST
    [str| (ZIP [] l2 = []) /\
          (ZIP (CONS h1 t1) l2 = CONS (h1,HD l2) (ZIP t1 (TL l2))) |]

tyDefCHAR' :: (BasicConvs thry, IndTypesCtxt thry) 
