...
defZERO' :: PairCtxt thry => HOL Theory thry HOLThm
defZERO' = newDefinition "_0"
    [str| _0 = mk_num IND_0 |]


defSUC' :: PairCtxt thry => HOL Theory thry HOLThm
defSUC' = newDefinition "SUC"
    [str| SUC n = mk_num (IND_SUC (dest_num n)) |]

defNUMERAL' :: PairCtxt thry => HOL Theory thry HOLThm
